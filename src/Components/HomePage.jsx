  ...
  return (
    <div className="relative overflow-hidden pt-10 min-h-screen bg-gradient-to-b from-pink-50 via-white to-purple-50">
      ...
      <motion.div
        ...
        className="absolute top-14 right-4 w-40 h-40 sm:w-56 sm:h-56 bg-pink-300/30 blur-3xl rounded-full"
      />

      <motion.div
        animate={{ opacity: [0.15, 0.3, 0.15], scale: [1.1, 0.9, 1.2] }}
        transition={{ duration: 7, repeat: Infinity }}
        className="absolute bottom-14 left-4 w-44 h-44 sm:w-60 sm:h-60 bg-purple-300/30 blur-3xl rounded-full"
      />
      ...
      <div
        className="
          ...
          items-center 
          py-10 md:py-0 lg:py-0
          min-h-[88vh] md:min_h-[90vh] lg:min-h-[92vh]
          relative z-10
        "
      >
        ...
        >
          <motion.img
            ...
            className="
              ...
              w-[95%] sm:w-[85%] md:w-[110%] lg:w-[115%] xl:w-[120%]
        ...
        >
          <h1
            className="
              ...
              md:text-[42px] lg:text-[46px] xl:text-[50px]
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mt-6">
            <motion.a
              ...
              className="
                w-full sm:w-auto
                px-10 py-3 text-base md:text-[18px] font-semibold
